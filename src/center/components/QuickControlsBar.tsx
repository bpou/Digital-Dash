        ...
        <div className="flex items-center gap-1">
          ...
          >
            {audio.nowPlaying.isPlaying ? (
              <img src="/recolored_C7C7C7/noun-pause-3751099.png" alt="" className="h-4 w-4 object-contain" />
            ) : (
              <img src="/recolored_C7C7C7/noun-play-3751096.png" alt="" className="h-4 w-4 object-contain" />
            )}
          </button>
          <button
            type="button"
          ...
          >
            <img src="/recolored_C7C7C7/noun-forward-3751113.png" alt="" className="h-4 w-4 object-contain" />
          </button>
        </div>
      </motion.button>
