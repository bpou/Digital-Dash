...
Item {
    ...
    Item {
        ...
        Loader {
            ...
            anchors.fill: parent
            active: root.activePage === "NAVIGATION"
            source: externalQmlDir + "NativeNavigationView.qml"
        }

        Binding {
            target: navigationPageLoader.item
            property: "gps"
            value: root.gps
        }
        ...
        Connections {
            ...
            function onClimateSetRequested(next) {
                root.sendClimate(next);
            }
        }
    }
