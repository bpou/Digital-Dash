...
```bash
sudo apt update
sudo apt install -y build-essential cmake ninja-build qt6-base-dev qt6-declarative-dev qt6-websockets-dev qt6-positioning-dev qt6-location-dev qml6-module-qtquick qml6-module-qtquick-controls qml6-module-qtlocation qml6-module-qtpositioning
